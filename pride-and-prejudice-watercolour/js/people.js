...
(function (WC) {
  ...
  // coat tails: they hang against the back of his thighs, the inner edge just inside the back of the
  // legs so the two rims meet without a seam or a gap, and the silhouette reads as one figure
  // rather than a stick hanging behind him
  DC.tailsPts = [[-0.440, 2.850], [-0.500, 3.100], [-0.520, 3.700], [-0.480, 4.400], [-0.380, 4.950, 'c'],
    [-0.200, 4.880], [-0.170, 4.400], [-0.150, 3.700], [-0.200, 3.000]];
