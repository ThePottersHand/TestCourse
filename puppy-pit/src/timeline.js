...
const CUT = [
  ...
  ['face', 'present', 'face', 4.7],
  ['abyss', 'topdown', 'abyss', 10.55],
  ['reveal', 'topdown', 'reveal', 13.02],
  ...
  ['colinPhone', 'colin', 'colinPhone', 82.3],
  ['twenty', 'inpit', 'twenty', 85.6],
  ['rescue', 'rescue', 'rescue', 93.45],
  ['wisdom', 'inpit', 'wisdom', 103.7],
  ['lifted', 'lift', 'lifted', 110.35],
  ['portrait', 'portrait', 'portrait', 112.9],
